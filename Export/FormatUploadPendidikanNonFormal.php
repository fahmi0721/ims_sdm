...
$objPHPExcel->setActiveSheetIndex(0)
            ->setCellValue('B1', 'PETUNJUK PENGISIAN FORM UPLOAD DATA PENDIDIKAN NON FROMAL')
            ...
            ->setCellValue('C9', 'PENGISIAN TANGGAL MNGGUNKAN FORMAT YYYY-MM-DD CONTOH (2023-12-31)')
            ->setCellValue('C3', 'KETERANGAN');

// Add some data
$RowAwal = 4;
$objPHPExcel->setActiveSheetIndex(0) 
            ->setCellValue('E2', 'PENDIDIKAN NON FORMAL')
            ->setCellValue('E3', 'KODE')
            ->setCellValue('F3', 'PENDIDIKAN NON FORMAL');

$LoadPendidikanNonFormal = LoadPendidikanNonFormal();
if($LoadPendidikanNonFormal['Row'] > 0){
    $i = $RowAwal;
    foreach($LoadPendidikanNonFormal['Data'] as $key => $IData){
        $objPHPExcel->setActiveSheetIndex(0)
...
$objPHPExcel->setActiveSheetIndex(1)
            ...
            ->setCellValue('C1', 'KODE PENDIDIKAN NON FORMAL')
            ->setCellValue('D1', 'TANGGAL MULAI BERLAKU')
            ->setCellValue('E1', 'TANGGAL BATAS BERLAKU')
...
$objPHPExcel->setActiveSheetIndex(1)->getStyle("D1:F1")->applyFromArray($Orange);
...
$objPHPExcel->getActiveSheet(1)->setTitle('FORM UPLOAD PEND NON FORMAL');
