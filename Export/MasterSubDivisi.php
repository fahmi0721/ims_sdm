...
$objPHPExcel->getProperties()->setCreator("PT ISMA")
							 ...
							 ->setDescription("Master Sub Divisi")
							 ->setKeywords("Master Sub Divisi")
							 ->setCategory("Master Sub Divisi");
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C1', 'NAMA SUB DIVISI')
            ->setCellValue('D1', 'STATUS');
            
$Row = 2;
$Data = LoadDataMasterSubDivisi();
if($Data['Row'] > 0){
    $No=1;
    foreach($Data['Data'] as $key => $r){
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C'.$Row, $r['NamaSubDivisi'])
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Master Sub Divisi');
...
header('Content-Disposition: attachment;filename="'.$Time.'-Master Sub Divisi.xls"');
