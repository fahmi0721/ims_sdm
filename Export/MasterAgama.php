...
$objPHPExcel->getProperties()->setCreator("PT ISMA")
							 ...
							 ->setDescription("Master Agama")
							 ->setKeywords("Master Agama")
							 ->setCategory("Master Agama");
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Master Agama');
...
header('Content-Disposition: attachment;filename="'.$Time.'-Master Agama.xls"');
