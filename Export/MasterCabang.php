...
$objPHPExcel->getProperties()->setCreator("PT ISMA")
							 ...
							 ->setDescription("Master Cabang")
							 ->setKeywords("Master Cabang")
							 ->setCategory("Master Cabang");
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Master Cabang');
...
header('Content-Disposition: attachment;filename="'.$Time.'-Master Cabang.xls"');
