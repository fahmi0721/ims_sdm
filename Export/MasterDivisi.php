...
$objPHPExcel->getProperties()->setCreator("PT ISMA")
							 ...
							 ->setDescription("Master Divisi")
							 ->setKeywords("Master Divisi")
							 ->setCategory("Master Divisi");
...
if($Data['Row'] > 0){
    ...
    foreach($Data['Data'] as $key => $r){
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('C'.$Row, $r['NamaDivisi'])
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Master Divisi');
...
header('Content-Disposition: attachment;filename="'.$Time.'-Master Divisi.xls"');
