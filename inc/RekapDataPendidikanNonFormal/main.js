...
function Export(){
	...
	window.open("Export/RekapDataSertifikasi.php?" + iData, "MsgWindow", "width=200,height=100");
}
...
function getPendidikan(){
	$.ajax({
		type : "POST",
		url	 : "inc/RekapDataPendidikanNonFormal/proses.php?proses=LoadData",
		...
		success: function(r){
			...
			var opt = "<option value=''>Pilih Sertifikasi</option>";
...
function LoadData(page) {
	...
	$.ajax({
		type: "POST",
		url: "inc/RekapDataPendidikanNonFormal/proses.php?proses=DetailData",
		data: iData,
		beforeSend: function () {
			StartLoad();
		},
...
function Clear(){
	$("#Title").html("Berdasarkan Sertifikasi");
