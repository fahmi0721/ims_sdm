            ...
            <div class='row'>
                <div class='col-sm-3 col-md-4'>
                    <ul>
                        ...
                        <li><small>Pilih Sertifikasi unutk menampilkan rekapan tenaga kerja berdasrkan Sertifikasi</small></li>
                    </ul>
                </div>
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Sertifikasi </label>
                            <select class='form-control select-kode' name='Kode' id='Kode'></select>
                        </div>
