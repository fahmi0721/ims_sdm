    ...
    <div class="box-header with-border">
        ...
        <div class='pull-right box-tools'>
            <div class='btn-group' id='BtnControl'>
                <a target='_blank' href='Export/MasterSeksi.php' class='btn btn-sm btn-success' title='Download Data' data-toggle='tooltip'><i class='fa fa-download'></i> Download Data</a>
    ...
    <div class="box-body">
            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Nama Seksi/Jabatan <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete='off' name='NamaSeksi' id='NamaSeksi' placeholder='Nama Seksi' class='form-control FormInput'>
                        </div>
                        <div class='col-sm-6'>
        ...
        <div id="DetailData">
            ...
            <div class="col-sm-3 col-sm-offset-8">
                <div class='input-group'>
                    <input type='text' id='Search' onkeyup='LoadData()' data-toggle='tooltip' title='Masukkan Nama / Kode Seksi' class='form-control' placeholder='Cari Nama / Kode Kesi...'> 
