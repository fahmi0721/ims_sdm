    ...
    <div class="box-header with-border">
        ...
        <div class='pull-right box-tools'>
            <div class='btn-group' id='BtnControl'>
                <a target='_blank' href='Export/MasterAgama.php' class='btn btn-sm btn-success' title='Download Data' data-toggle='tooltip'><i class='fa fa-download'></i> Download Data</a>
    ...
    <div class="box-body">
            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Nama Agama <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete=off class='form-control FormInput'name='Nama' id='Nama' placeholder='Nama Agama' />
                        </div>
                        <div class='col-sm-6'>
        ...
        <div id="DetailData">
            ...
            <div class="col-sm-3 col-sm-offset-8">
                <div class='input-group'>
                    <input type='text' id='Search' onkeyup='LoadData()' data-toggle='tooltip' title='Masukkan Nama / Kode Agama' class='form-control' placeholder='Cari Nama / Kode Agama...'> 
