        ...
        <form id="FormData" class='form-horizontal' action="#">
            ...
            <div class='row'>
                <div class='col-sm-3 col-md-4'>
                    <ul>
                        <li><small>Pilih periode yang akan dicari</small></li>
                        <li><small>Periode yang tampil adalah periode yang telah di backup</small></li>
                    </ul>
                </div>
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <select class='form-control select-periode' name='Periode' id='Periode'></select>
                        </div>
