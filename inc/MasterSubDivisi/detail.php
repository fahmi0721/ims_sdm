    ...
    <div class="box-header with-border">
        ...
        <div class='pull-right box-tools'>
            <div class='btn-group' id='BtnControl'>
                <a target='_blank' href='Export/MasterSubDivisi.php' class='btn btn-sm btn-success' title='Download Data' data-toggle='tooltip'><i class='fa fa-download'></i> Download Data</a>
    ...
    <div class="box-body">
            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Nama Sub Divisi <span class='text-danger'>*</span></label>
                            <input type='text' name='NamaSubDivisi' autocomplete='off' id='NamaSubDivisi' placeholder='Nama Sub Divisi' class='form-control FormInput'>
                        </div>
                        <div class='col-sm-6'>
        ...
        <div id="DetailData">
            ...
            <div class="col-sm-3 col-sm-offset-8">
                <div class='input-group'>
                    <input type='text' id='Search' onkeyup='LoadData()' data-toggle='tooltip' title='Masukkan Nama / Kode Sub Divisi' class='form-control' placeholder='Cari Nama / Kode Sub Divisi...'> 
