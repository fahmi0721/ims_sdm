...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title" id="Title">Upload Data PHK</h3>
        <div class='pull-right box-tools'>
            <div class='btn-group' id='BtnControl'>
                <a href="Export/FormatUploadPhk.php" target='_blank' class='btn btn-sm btn-success' title='Dowload Template' data-toggle='tooltip'><i class='fa fa-download'></i> Download Template</a>
            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Daftar PHK <span class='text-danger'>*</span></label>
