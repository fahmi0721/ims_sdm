                ...
                <div class='col-sm-3 col-md-4'>
                    <small>Catatan:
                        <ul>
                            ...
                            <li> Format upload data download disini <a href='Export/FormatUploadRekening.php' target='_blank' data-toggle='tooltip' title='Unduh Format Upload' class='btn btn-xs btn-success'><i class='fa fa-download'></i></a></li>
                        </ul>
                    </small>
                </div>
