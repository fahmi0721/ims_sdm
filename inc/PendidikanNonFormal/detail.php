        ...
        <form id="FormData" class="form-horizontal" action="#">
            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Berlaku Dari<span class='text-danger'>*</span></label>
                            <div class='input-group'>
                                <input type='text' autocomplete=off class='form-control FormInput Tahun' name='Dari' id='Dari' placeholder='Berlaku Mulai' />
                        ...
                        <div class='col-sm-6'>
                            ...
                            <div class='input-group'>
                                <input type='text' autocomplete=off class='form-control Tahun FormInput' name='Sampai' id='Sampai' placeholder='Berlaku Selesai' />
                                <span class='input-group-addon'><i class='fa fa-calendar'></i></span>
                            </div>
                        </div>
                    </div>
