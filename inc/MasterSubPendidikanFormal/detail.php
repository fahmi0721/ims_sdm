    ...
    <div class="box-body">
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <input type='text' name='Nama' id='Nama' autocomplete=off class='form-control FormInput' placeholder='Jurusan'>
                        </div>
                        <div class='col-sm-6'>
        ...
        <div id="DetailData">
            ...
            <div class="col-sm-3 col-sm-offset-8">
                <div class='input-group'>
                    <input type='text' id='Search' onkeyup='LoadData()' data-toggle='tooltip' title='Masukkan Nama / Kode Master Sub Pendidikan' class='form-control' placeholder='Cari Nama / Kode Master Sub Pendidikan...'> 
