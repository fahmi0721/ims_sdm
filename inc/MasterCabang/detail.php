...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <div class='pull-right box-tools'>
            ...
            <a target='_blank' href='Export/MasterCabang.php' class='btn btn-sm btn-success' title='Download Data' data-toggle='tooltip'><i class='fa fa-download'></i> Download Data</a>
            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Nama Cabang <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete=off class='form-control FormInput'name='NamaCabang' id='NamaCabang' placeholder='Nama Cabang' />
                        </div>
                        <div class='col-sm-6'>
