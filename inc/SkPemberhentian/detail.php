            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6' id="NoKtpE">
                            <label class="control-label">No KTP <span class='text-danger'>*</span></label>
                            <input type='text' name='NoKtpEdit' autocomplete=off id='NoKtpEdit' readonly class='form-control FormInput' placeholder='No KTP'>
                        </div>
                        <div class='col-sm-6' id="NoKtpNE">
                        ...
                        <div class='col-sm-6'>
                            ...
                            <div class='input-group'>
                                <input type='text' name='Tmt' autocomplete=off id='Tmt' class='form-control FormInput' placeholder='TMT'>
                    ...
                    <div class="form-group">
                        ...
                        <div class='col-sm-6'>
                            <label class="control-label">Kategori SK <span class='text-danger'>*</span></label>
                            <select class='form-control FormInput select-kategori' name='Kategori' id='Kategori'>
                                <option value=''>..:: Pilih Kategori SK</option>
                                <option value='0'>Pemberhentian</option>
                                <option value='1'>Pengunduran Diri</option>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <div class='input-group'>
                                <input type='file'  class='form-control FormInput' name='File' id='File'  />
