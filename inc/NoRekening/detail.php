    ...
    <div class="box-body">
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        ...
                        <div class='col-sm-6'>
                            ...
                            <select class='form-control FormInput select-kode-bank' name='KodeBank' id='KodeBank'></select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Nomor Rekening <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete=off onkeyup='angka(this)' class='form-control FormInput' name='NoRek' id='NoRek' placeholder='Nomor Rekening' />
                        </div>
                        <div class='col-sm-6'>
        ...
        <div id="DetailData">
            ...
            <div class="col-sm-3 col-sm-offset-8">
                <div class='input-group'>
                    <input type='text' id='Search' onkeyup='LoadData()' data-toggle='tooltip' title='Masukkan Nama Tenaga Kerja / Nomor Rekening' class='form-control' placeholder='Cari Nama Tenaga Kerja / Nomor Rekening...'> 
