                    ...
                    <div class="form-group">
                        ...
                        <div class='col-sm-6'>
                            ...
                            <div class='input-group'>
                                ...
                                <input type='text' autocomplete=off  class='form-control FormInput' name='Baju' id='Baju' placeholder='Baju' />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <div class='input-group'>
                                <span class='input-group-addon'>Size</span>
                                <input type='text' autocomplete=off  class='form-control FormInput' name='Celana' id='Celana' placeholder='Celana' />
                            </div>
                        </div>
                        <div class='col-sm-6'>
                            ...
                            <div class='input-group'>
                                <span class='input-group-addon'>Size</span>
                                <input type='text' autocomplete=off  class='form-control FormInput' name='Sepatu' id='Sepatu' placeholder='Sepatu' />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <div class='input-group'>
                                <span class='input-group-addon'>Size</span>
                                <input type='text' autocomplete=off  class='form-control FormInput' name='Topi' id='Topi' placeholder='Topi' />
                            </div>
                        </div>
                        ...
                        <div class='col-sm-6'>
                            ...
                            <div class='input-group'>
                                <span class='input-group-addon'>Size</span>
                                <input type='text' autocomplete=off  class='form-control FormInput' name='Ped' id='Ped' placeholder='Ped' />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
