            ...
            <div class='row'>
                <div class='col-sm-3 col-md-4'>
                    <ul>
                        ...
                        <li><small>Pilih Jenis Kelamin unutk menampilkan rekapan tenaga kerja berdasrkan Jenis Kelamin</small></li>
                    </ul>
                </div>
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <select class='form-control select-jk' name='Jk' id='Jk'></select>
                        </div>
