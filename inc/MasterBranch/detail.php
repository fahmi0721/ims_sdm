    ...
    <div class="box-body">
            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Kode Branch <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete=off class='form-control FormInput' name='Kode' id='Kode' placeholder='Kode Branch' />
                        </div>
                        <div class='col-sm-6'>
                            <label class="control-label">Nama Branch <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete=off class='form-control FormInput' name='Nama' id='Nama' placeholder='Nama Branch' />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class='col-sm-6'>
        ...
        <div id="DetailData">
            ...
            <div class="col-sm-3 col-sm-offset-8">
                <div class='input-group'>
                    <input type='text' id='Search' onkeyup='LoadData()' data-toggle='tooltip' title='Masukkan Nama / Kode Branch' class='form-control' placeholder='Cari Nama / Kode Branch...'> 
