            ...
            <div class='row'>
                <div class='col-sm-3 col-md-4'>
                    <ul>
                        ...
                        <li><small>Pilih branch, divisi,sub divisi atau seksi unutk menampilkan rekapan tenaga kerja berdasrkan divisi,sub divisi atau seksi</small></li>
                    </ul>
                </div>
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <select class='form-control select-branch' name='KodeBranch' id='KodeBranch'></select>
                        </div>
                        <div class='col-sm-6'>
                            <label class="control-label">Divisi </label>
                            <select class='form-control select-divisi' name='KodeDivisi' id='KodeDivisi'></select>
                        </div>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <select class='form-control select-sub-divisi' name='KodeSubDivisi' id='KodeSubDivisi'></select>
                        </div>

                        <div class='col-sm-6'>
                            <label class="control-label">Seksi / Jabatan</label>
                            <select class='form-control select-seksi' name='KodeSeksi' id='KodeSeksi'></select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
