    ...
    <div class="box-body">
            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        ...
                        <div class='col-sm-6'>
                            <label class="control-label">Cif Peserta <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete=off onkeyup='angka(this)' class='form-control FormInput' name='Cif' id='Cif' placeholder='Cif Peserta' />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">No Akun DPLK <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete=off onkeyup='angka(this)' class='form-control FormInput' name='NoAccount' id='NoAccount' placeholder='Nomor Akun DPLK' />
                        </div>
                        <div class='col-sm-6'>
                            <label class="control-label">Tangal Daftar</label>
                            <div class='input-group'>
                                <input type='text'  class='form-control FormInput' autocomplete=off placeholder='Tanggal Daftar' name='TglDaftar' id='TglDaftar' />
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <div class='input-group'>
                                <input type='file' accept='.jpg,.jpeg,.png,.pdf' class='form-control FormInput' data-toggle='tolltip' title='Masukkan File Gambar atau PDF' name='File' id='File' />
        ...
        <div id="DetailData">
            ...
            <div class="col-sm-3 col-sm-offset-8">
                <div class='input-group'>
                    <input type='text' id='Search' onkeyup='LoadData()' data-toggle='tooltip' title='Masukkan Nama Tenaga Kerja / Nomor Akun DPLK' class='form-control' placeholder='Cari Nama Tenaga Kerja / Nomor Akun DPLK...'> 
