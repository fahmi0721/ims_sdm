                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        ...
                        <div class='col-sm-6'>
                            ...
                            <select class='form-control select-tingkat' name='KodeMaster' id='KodeMaster'></select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Tahun Mulai<span class='text-danger'>*</span></label>
                            <div class='input-group'>
                                <input type='text' autocomplete=off class='form-control FormInput Tahun' name='TahunMulai' id='TahunMulai' placeholder='Tahun Mulai' />
                                <span class='input-group-addon'><i class='fa fa-calendar'></i></span>
                            </div>
                        </div>
                         <div class='col-sm-6'>
                            <label class="control-label">Jurusan</label>
                            <select class='form-control select-jurusan' name='KodeSubMaster' id='KodeSubMaster'></select>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Tahun Selesai<span class='text-danger'>*</span></label>
                            <div class='input-group'>
                                <input type='text' autocomplete=off class='form-control Tahun FormInput' name='TahunSelesai' id='TahunSelesai' placeholder='Tahun Selesai' />
                                <span class='input-group-addon'><i class='fa fa-calendar'></i></span>
                            </div>
                        </div>
                        <div class='col-sm-6'>
