            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Kode Bank <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete=off class='form-control FormInput' name='Kode' id='Kode' placeholder='Kode Bank' />
                        </div>
                        <div class='col-sm-6'>
                            <label class="control-label">Nama Bank <span class='text-danger'>*</span></label>
                            <input type='text' autocomplete=off class='form-control FormInput' name='Nama' id='Nama' placeholder='Nama Bank' />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class='col-sm-6'>
