<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title" id="Title">Rekap Data Satuan Kerja</h3>
    </div>
    
    <div class="box-body">
        <div class="col-sm-12"><div class="row"><div id="proses"></div></div></div>
        <form id="FormData" class='form-horizontal' action="#">
            <input type="hidden" name="aksi" id="aksi" value="data_tenaga_kerja">
            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class='col-sm-6'>
                            ...
                            <select class='form-control select-branch' name='KodeBranch' id='IdBranch'></select>
                        </div>
                        <div class='col-sm-6'>
