            ...
            <div class='row'>
                ...
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        ...
                        <div class='col-sm-6'>
                            <label class="control-label">No JKN/KIS<span class='text-danger'>*</span></label>
                            <input type='text' onkeyup='angka(this)' class='form-control FormInput' name='NoJkn' id='NoJkn' placeholder='No JKN/KIS'>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class='col-sm-6'>
                            <label class="control-label">Status Kepesertaan<span class='text-danger'>*</span></label>
                            <select class='form-control select-status' name='StatusKepesertaan' id='StatusKepesertaan'>
                                <option value=''>Pilih Status Kepesrtaan</option>
                                <option value='0'>PT ISMA</option>
                                <option value='1'>TNI/POLRI</option>
                                <option value='2'>JAMKESDA/JAMKESMAS/JAMKESTA</option>
                                <option value='3'>NON PNS</option>
                                <option value='4'>PBI APBN / APBD</option>
