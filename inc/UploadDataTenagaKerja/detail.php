                ...
                <div class='col-sm-3 col-md-4'>
                    <small>Catatan:
                        <ul>
                            ...
                            <li> Format upload data download disini <a href='Export/FormatUploadTenagaKerja.php' target='_blank' data-toggle='tooltip' title='Unduh Format Upload' class='btn btn-xs btn-success'><i class='fa fa-download'></i></a></li>
                        </ul>
                    </small>
                </div>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <div class="input-group">
                                <input type='file' autocomplete=off accept='.xlsx' class='form-control FormInput'name='File' id='File' />
