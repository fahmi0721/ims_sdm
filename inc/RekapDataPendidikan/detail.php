            ...
            <div class='row'>
                <div class='col-sm-3 col-md-4'>
                    <ul>
                        ...
                        <li><small>Pilih Pendidikan unutk menampilkan rekapan tenaga kerja berdasrkan Pendidikan</small></li>
                    </ul>
                </div>
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <select class='form-control select-formal' name='KodeFormal' id='KodeFormal'></select>
                        </div>
                        <div class='col-sm-6'>
                            <label class="control-label">Jurusan </label>
                            <select class='form-control select-jurusan' name='KodeJurusan' id='KodeJurusan'></select>
                        </div>
