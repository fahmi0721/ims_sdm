...
function getAgama(){
	$.ajax({
		type : "POST",
		url : "inc/RekapDataAgama/proses.php?proses=LoadData",
		data : "rule=Agama",
		beforeSend : function(){
			StartLoad();
		},
...
function LoadData(page) {
	$("#ShowData").hide();
	var Agama = $("#Agama").val() == undefined ? "" : $("#Agama").val();
	var Pages = btoa(getUrl('page'));
	$.ajax({
		type: "POST",
		url: "inc/RekapDataAgama/proses.php?proses=DetailData",
		data: "Agama=" + Agama,
		beforeSend: function () {
			StartLoad();
		},
