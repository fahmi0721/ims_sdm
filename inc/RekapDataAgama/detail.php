            ...
            <div class='row'>
                <div class='col-sm-3 col-md-4'>
                    <ul>
                        ...
                        <li><small>Pilih agama unutk menampilkan rekapan tenaga kerja berdasrkan agama</small></li>
                    </ul>
                </div>
                <div class='col-sm-9 col-md-8'>
                    ...
                    <div class="form-group">
                        <div class='col-sm-6'>
                            ...
                            <select class='form-control select-agama' name='Agama' id='Agama'></select>
                        </div>
